...
parser.add_argument("-ni", "--num_iters", help="训练迭代次数", type=int, default=10000)#50000
...
# 将合并后的图像保存为PNG文件
imageio.imwrite(f'./ep2/result/block{int(args.num_blocks)}train{int(args.num_iters)}/train{int(args.num_iters)}.png', merged_img)
