...
def parse_args():
	...
	parser.add_argument("--video_in", default="./stock.mov", help="Run ffmpeg first to convert a provided video file into a set of images. Uses the video_fps parameter also.")
